...
El anterior gráfico muestra como en el panel de entorno se van guardandfo las variables y funciones que se van creando. Hablemos al respecto:
...
El último panel permitira visualizar gráficos, explorar archivos y consultar la ayuda de R. Además permitirá ver la lista de paquetes y ahí abrirá la documentación cuando la necesitemos:
