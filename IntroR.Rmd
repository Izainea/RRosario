...
Este último ejercicio debió darle problemas, pues tuvo que poner cada línea de lo que escribió para lograr el resultado deseado. El área de trabajo de RStudio permite que este ejercicio no sea tan complicado, usaremos scripts de R, que no son más que ficheros de instrucciones.
